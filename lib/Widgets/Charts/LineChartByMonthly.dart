...
class LineChartByMonth extends StatefulWidget {
  final ConsumationDayBean consumationDayBean;
  const LineChartByMonth({super.key, required this.consumationDayBean});

  @override
  State<LineChartByMonth> createState() => _LineChartByMonthState();
}

class _LineChartByMonthState extends State<LineChartByMonth> {
